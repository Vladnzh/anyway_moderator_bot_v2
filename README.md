...
- 📢 **Массовая рассылка** - отправка сообщений пользователям с фильтрацией по условиям из Supabase
...
- **[BROADCAST_README.md](BROADCAST_README.md)** - 📢 Краткая инструкция по массовой рассылке
- **[BROADCAST_GUIDE.md](BROADCAST_GUIDE.md)** - 📢 Полное руководство по массовой рассылке с примерами
