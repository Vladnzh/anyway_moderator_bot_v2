...
echo ""
echo "🏗️ 4. Пересобираем образы..."
docker compose build

echo ""
echo "🚀 5. Запускаем обновлённые контейнеры..."
docker compose up -d

echo ""
echo "⏳ 6. Ждём запуска (15 секунд)..."
sleep 15
...
echo ""
echo "📋 9. Показываем логи (последние 10 строк)..."
